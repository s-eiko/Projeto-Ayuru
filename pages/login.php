...
<body>
    ...
    <main>
        ...
        <div style="text-align: center;">
            <a href="cadastro.php" style="background-color: #325D2F; padding: .5rem; color: #F0F7DA; border-radius: 10px; text-decoration: none;">Não possui conta? Cadastro</a>
        </div>
        <form id="form" action="login.php" method="post" style="display: flex; flex-direction: column; gap: 1rem; padding: 3rem;">
            <tr>
