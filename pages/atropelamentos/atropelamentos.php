...
<body>
    ...
    <main>
        ...
        <h3>Atenção: Conteúdo sensível! Para ver as imagens sem censura clique em cima delas</h3>
        <div class="filtro">
            <form id="nid" action="atropelamentos.php" method="post">
                <input value="Espécies não identificadas" type="text" name="nid" onclick="document.getElementById('nid').submit()" readonly/>
            </form>
        ...
        ?>
            <div class="post">
                <img id="foto<?php echo $id?>" src="<?php echo "../../images/".$linha["foto"];?>" style="filter: blur(10px);"
                ...
                ?>
                    <div style="text-align: right;">
                        <?php if ($linha["especie"] == "Não identificado") {
                            $id = $linha["id_at"];
                        ...
                        <a href='../../crud.php?acao=E&post=atropelamento&id=<?php echo $linha["id_at"]?>'>
    ...
    <?php 
        ...
        "<a href='../../crud.php?acao=P&post=atropelamento'>
