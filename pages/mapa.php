    ...
    <main>
        ...
        <div id="est" style="display: none;">
            <div>
                ...
                <img src="../graphs/gr-fauna.php" alt="Gráfico fauna">
            </div>
            <div>
                ...
                <img src="../graphs/gr-flora.php" alt="Gráfico flora">
            </div>
            <div>
                ...
                <img src="../graphs/gr-atropelamento.php" alt="Gráfico atropelamentos">
            </div>
        </div>
    </main>
</body>
